...
<section class="country-hero">
  <div class="container country-hero__grid">
    ...
    <div class="country-hero__media">
      <img src="<?=$firstSection['картинка'];?>" alt="Автомобиль из США" />
    </div>
  </div>
</section>

<section id="country-catalog" class="section section--tight-top country-catalog section-anchor" data-country-catalog data-country="США" data-country-page-size="<?php echo esc_attr( (string) autoimport_catalog_page_size() ); ?>">
  <div class="container">
