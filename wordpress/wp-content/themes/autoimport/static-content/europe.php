...
<section class="country-hero">
  <div class="container country-hero__grid">
    <div class="country-hero__content">
      ...
      <div class="btn-row">
        <button type="button" class="btn btn--primary" data-open-form data-form-title="Подобрать авто из Европы" data-form-source="Страница / Европы" data-form-country="Европы" data-form-button-text="Подобрать авто">
    ...
    <div class="country-hero__media">
      <img src="<?=$firstSection['картинка'];?>" alt="Автомобиль из Европы" />
    </div>
  </div>
</section>

<section id="country-catalog" class="section section--tight-top country-catalog section-anchor" data-country-catalog data-country="Европа" data-country-page-size="<?php echo esc_attr( (string) autoimport_catalog_page_size() ); ?>">
  <div class="container">
