	...
	<div class="container footer-grid">
		...
		<div class="footer-col">
			...
			<ul class="footer-nav">
				...
				<li><a href="<?php echo esc_url( home_url( '/sitemap' ) ); ?>"><?php esc_html_e( 'Карта сайта', 'autoimport' ); ?></a></li>
			...
			<ul class="footer-nav">
				...
				<li>
					<div class="messengers footer-messengers" aria-label="<?php esc_attr_e( 'Мессенджеры', 'autoimport' ); ?>">
						...
						<a href="https://wa.me/78001234567" target="_blank" rel="noopener noreferrer" title="WhatsApp">
				...
				<li><?php esc_html_e( 'Москва, пример адреса', 'autoimport' ); ?></li>
			</ul>
		</div>
	</div>
